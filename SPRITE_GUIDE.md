...
sit_01.png   sit_02.png   sit_03.png                 ← 坐姿动画（至少2帧）
sleep_01.png sleep_02.png                            ← 睡觉动画（至少2帧）
rest_01.png  rest_02.png                             ← 休息动画（至少2帧）
```

中文文件名同样支持：`行走_01.png`、`坐姿_01.png`、`睡觉_01.png`、`休息_01.png`。
...
2. 用 **EZGIF** 或 PS 拆分帧，命名为 `行走_01.png`、`坐姿_01.png` 等
...
如果没有 `manifest.json`，应用会自动按 `walk_0X.png`、`sit_0X.png` 等命名规律加载。
