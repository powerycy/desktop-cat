...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let work_minutes = store.get("work_interval_minutes")
                .and_then(|v| v.as_u64())
                .unwrap_or(45);
            let rest_minutes = store.get("rest_duration_minutes")
                .and_then(|v| v.as_u64())
                .unwrap_or(5);
            let rest_mode = store.get("rest_mode")
            ...
            app.listen("force-rest", move |_event| {
                let rest_duration = {
                ...
                let _ = handle_for_force.emit("rest-start", serde_json::json!({
