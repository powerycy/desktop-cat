...
这个页面用于帮助用户选择要下载的版本。旧的 Windows 本地版继续保留，新的 AI iOS 版本线单独提供，不互相覆盖。
...
适合想查看 AI 形象生成、产品交付文档和 iOS 版本线的用户/开发者。

包含：

- AI 形象生成版本线
- Google AI Studio / Gemini 图片生成桌宠动作帧的代码路径
- 健康提醒、休息遮罩和本地统计说明
- 非商用许可证
...
说明：当前仓库中的 AI iOS 版本线已经单独上传，但 iOS 原生安装包仍需要后续补齐 iOS 打包配置后再发布。
